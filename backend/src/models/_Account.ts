...
export default class Account {
  ...
  get nextBillingDate() {
    ...
    let billingDate = dayjs().startOf('day').set('date', this.billingDay);
  ...
  get nextPaymentDate() {
    ...
    let paymentDate = dayjs().endOf('day').set('date', this.paymentDay);
  ...
  get currentBillingDate() {
    ...
    let billingDate = dayjs().endOf('day').set('date', this.billingDay);
